...
y
    ...
    <img className="singleImage" src={this.state.image}></img>
    <div>
    <h3 className="thumbnailText">{this.state.title}  - {this.state.author}</h3>
...
<div>
  <div>
<h3 className="thumbnailText">{item.title}</h3>
<span>
{item.author}
</span>
</div>
